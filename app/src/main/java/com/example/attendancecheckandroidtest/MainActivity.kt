...
//import com.example.attendancecheckandroidtest.data.models.Event // 필요한 경우
...
//                    val eventJson = backStackEntry.arguments?.getString("eventJson") ?: ""
//                    TimelineEventDetailScreen(eventJson = eventJson, onClose = { navController.popBackStack() }, onTabSelected = { selectedTabIndex = it }, isTimelineView = isTimelineView, refreshEvents = { /* Refresh events logic */ })
//                }
//                composable("caution") {
...
class MainActivity : ComponentActivity() {
    ...
    private fun scheduleNotifications() {
        val notificationManager = NotificationManager(this)
        notificationManager.scheduleNotificationList()
    }
